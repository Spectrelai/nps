...
sudo apt-get update
sudo apt-get install gcc-mingw-w64-i686 gcc-mingw-w64-x86_64 gcc-multilib
...
tar -czvf npc_sdk.tar.gz npc_386_sdk.dll npc_amd64_sdk.dll npc_386_sdk.so npc_amd64_sdk.h
