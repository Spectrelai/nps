...
env GOOS=windows GOARCH=386 CGO_ENABLED=1 CC=i686-w64-mingw32-gcc go build -ldflags "-s -w -extldflags -static -extldflags -static" -buildmode=c-archive -o libnpc_386_sdk.lib cmd/npc/sdk.go
...
env GOOS=windows GOARCH=amd64 CGO_ENABLED=1 CC=x86_64-w64-mingw32-gcc go build -ldflags "-s -w -extldflags -static -extldflags -static" -buildmode=c-archive -o libnpc_amd64_sdk.lib cmd/npc/sdk.go
...
tar -czvf npc_linux_sdk.tar.gz libnpc_arm_sdk.so libnpc_arm_sdk.a libnpc_arm_sdk.h
